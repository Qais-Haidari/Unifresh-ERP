const GetUserLatLot = async (username) => {
    let Report = `
        select CUSTOMER, LATITUDE, LONGITUDE from CUSTOMERMASTER where CUSTOMERSTATUS='Active' and customer = '${username}'
    `;
