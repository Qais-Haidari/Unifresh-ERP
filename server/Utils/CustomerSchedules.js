...
var Report = require("../SQL/Customers");

const CustomerSchedules = async (customer) => {
  ...
  const response = await fetch(requestEndpoint, {
    method: "POST",
    body: `select * from UF_CUST_SCHEDULES where UF_CUST_SCHEDULES.CUSTOMER = '${customer}'`,
    headers: {
...
module.exports = CustomerSchedules;