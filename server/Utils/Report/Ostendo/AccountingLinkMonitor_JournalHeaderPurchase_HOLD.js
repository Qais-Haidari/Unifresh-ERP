const MissingCustomerSchedules = async (name) => {
    let Report = `
      update select journalinvheader set journalinvheader.TRANSACTIONSTATUS = 'HOLD' where journalinvheader.JOURNALNUMBER = '${name}' and journalinvheader.invoicetype = 'Sales'
    `;
