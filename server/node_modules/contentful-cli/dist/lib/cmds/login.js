...
const login = ({ context, managementToken: managementTokenFlag }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (managementTokenFlag) {
        ...
        console.log(`A browser window will open where you will log in (or sign up if you don’t have an account), authorize this CLI tool and paste your ${(0, styles_1.highlightStyle)('CMA token')} here:\n`);
