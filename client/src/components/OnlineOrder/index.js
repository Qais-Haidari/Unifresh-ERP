...
export default function Example() {
  ...
  useEffect(() => {
    ...
    axios
          .get(`http://10.0.0.223:5000/Users/User/TodayOrder/${localStorage.getItem('!@#!@#asdacas!@#')}`)
          .then((res) => {
            if (res.data[0].ORDERNUMBER) {
                axios
                .get(`http://10.0.0.223:5000/onlineOrdering/ordering/ETA/${res.data[0].ORDERNUMBER}`)
                .then((res) => {
                  setOrderItem(res.data)
                }
                ).catch((err) => (document.body.innerHTML = err));
                axios
                .get(`http://10.0.0.223:5000/Users/User/FourJourney/${res.data[0].ORDERNUMBER}`)
                .then((res) => {
